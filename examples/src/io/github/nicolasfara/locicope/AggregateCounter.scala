...
import io.github.nicolasfara.locicope.placement.PlacedFlow.{ PlacedFlow, take }
...
object AggregateCounter:
  ...
  def counter(using Network, Collective, PlacedFlow, PlacedValue) =
    ...
    on[Smartphone]:
      ...
      counters.take(10).runForeach: count =>
  ...
  def main(args: Array[String]): Unit =
    ...
    val complete = Future.sequence(List(smartphone1Future, smartphone2Future))
