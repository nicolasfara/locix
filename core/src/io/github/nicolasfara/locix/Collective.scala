...
//   inline def collective[P <: TiedToMultiple[P]: PeerRepr](using
//       coll: Collective,
//       pf: PlacedFlow,
//       net: Network,
...
//       val resultFlow: Flow[V] = ??? //FlowOps.onEvery(every):
...
//     // override protected[locix] val localPeerRepr: PeerRepr = peerRepr
...
//   trait Effect:
//     // protected[locix] val localPeerRepr: PeerRepr
